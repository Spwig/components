"""
Fixer.io Provider
Real-time currency exchange rates from Fixer.io API (APILayer)
"""
...
class FixerProvider(ExchangeRateProviderBase):
    ...
    def credential_schema(self) -> Dict[str, Any]:
        ...
        return {
            "access_key": {
                ...
                "label": "Access Key",
                "required": True,
                "help_text": "Your Fixer.io Access Key from the APILayer dashboard",
    ...
    def test_connection(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Fixer returns {"success": true, "symbols": {...}}
                if data.get('success'):
                    ...
                    return {
                        'success': True,
                        'message': f'Successfully connected to Fixer.io API ({currency_count} currencies available)',
                        'details': {
            ...
            return {
                'success': False,
                'message': 'Connection error - Unable to reach Fixer.io API',
    ...
    def get_exchange_rate(
        ...
        try:
            # Make API request - Fixer always returns rates relative to EUR
            response = requests.get(
                f"{self.BASE_URL}/latest",
                params={
                    'access_key': self.access_key,
                    # Free tier doesn't support base parameter, always EUR
            ...
            raise Exception("Connection error - unable to reach Fixer.io API")
    ...
    def get_rate_limits(self) -> Dict[str, Any]:
        ...
        """
        # Fixer doesn't provide rate limit info in response headers on free tier
        return {
