"""
USPS Provider Retry Logic

Implements retry decorator with exponential backoff for USPS API requests.
...
from .exceptions import USPSRateLimitError, USPSServiceUnavailableError
...
def retry_with_backoff(
    ...
    Example:
        ...
        def make_api_call():
            return requests.get('https://apis.usps.com/...')
    """
    if config is None:
        config = RetryConfig()
...
def calculate_delay(
    ...
    if isinstance(exception, USPSRateLimitError) and exception.retry_after:
